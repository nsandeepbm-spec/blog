          ...
          <article className="lg:col-span-8">
            ...
            <div
              className="
                ...
                [&_p]:mb-7
                [&>p:first-of-type]:first-letter:text-[96px] [&>p:first-of-type]:first-letter:font-black [&>p:first-of-type]:first-letter:float-left [&>p:first-of-type]:first-letter:mr-4 [&>p:first-of-type]:first-letter:mt-2 [&>p:first-of-type]:first-letter:leading-[0.75] [&>p:first-of-type]:first-letter:text-emerald-900 [&>p:first-of-type]:first-letter:font-lora
                [&_blockquote]:border-l-4 [&_blockquote]:border-emerald-600 [&_blockquote]:bg-emerald-50/50 [&_blockquote]:py-4 [&_blockquote]:pr-4 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-gray-700 [&_blockquote]:my-10 [&_blockquote]:text-[21px] [&_blockquote]:leading-relaxed
                [&_ul]:list-none [&_ul]:pl-0 [&_ul]:mb-8 [&_ul]:space-y-4
                [&_ul_li]:relative [&_ul_li]:pl-6 [&_ul_li::before]:content-[''] [&_ul_li::before]:absolute [&_ul_li::before]:left-0 [&_ul_li::before]:top-3.5 [&_ul_li::before]:w-2 [&_ul_li::before]:h-2 [&_ul_li::before]:bg-emerald-600 [&_ul_li::before]:rounded-sm
                [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mb-8 [&_ol]:space-y-4
                [&_li]:text-[19px] [&_li]:leading-[1.8] [&_li]:text-gray-800
                [&_a]:text-emerald-700 [&_a]:font-medium [&_a]:underline [&_a]:underline-offset-[5px] [&_a]:decoration-emerald-700/30 hover:[&_a]:decoration-emerald-700 hover:[&_a]:bg-emerald-50 transition-all
